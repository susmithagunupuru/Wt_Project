...
function setLang(lang) {
  currentLang = lang;
  const labels = { en:'EN', hi:'HI', te:'TE', ta:'TA', mr:'MR', bn:'BN' };
  document.querySelector('.btn-lang').textContent = '🌐 ' + (labels[lang] || 'EN');
  ...
  <div class="scheme-card">
    ...
    <div class="scheme-card-body">
      ...
      <div class="scheme-card-actions">
        <button class="btn-apply" onclick="applyScheme('${s.title.replace(/'/g,"\\'")}')">Apply Now</button>
...
function searchMap() {
  ...
  showToast(`🗺️ Searching near "${q}"…`);
  setTimeout(() => showToast('📍 Showing results near ' + q), 1400);
}
